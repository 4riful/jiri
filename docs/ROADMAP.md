...
- Stage E: AI Worker Benchmark scripts. Status: scaffolded in WSL, local ctx512 preflight allowed, real Pi benchmark required.
...
| E | AI Worker Benchmark | Scripts ready | Safe debloat, llama.cpp, Gemma 3 270M Q4_K_M benchmark at 512 ctx; WSL/local preflight is not acceptance. |
| F | AI Integration | Blocked for acceptance | Main Pi AI client remains disabled by default; production acceptance only after real Pi benchmark acceptance. |
